...
<html lang="en">
    ...
    <body>
        ...
        <div class="banner_area">
            <h2>Risk & Operational Management Courses</h2>
            <a href="#">Home > <span>Risk & Operational Management Courses</span></a>
        </div>
        <!--================End Banner Area =================-->  
                ...
                <div class="row service_row">
                    ...
                    <div class="col-lg-4 col-md-6 body_mind">
                        <a href="accrg.php">
                            <div class="media"> 
                                <div class="media-body">
                                    <h4>Advanced Certificate in Corporate Risk & Governance (ACCRG)</h4>
                                </div>
                            </div>
                        </a>
                    </div>

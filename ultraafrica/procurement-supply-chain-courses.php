...
<html lang="en">
    ...
    <body>
        ...
        <div class="banner_area">
            <h2>Procurement and Supply Chain Courses</h2>
            <a href="#">Home > <span>Procurement and Supply Chain Courses</span></a>
        </div>
        <!--================End Banner Area =================-->  
                ...
                <div class="row service_row">
                    ...
                    <div class="col-lg-4 col-md-6 body_mind">
                        <a href="acpc.php">
                            <div class="media"> 
                                <div class="media-body">
                                    <h4>Advanced Certificate in Procurement Compliance (ACP)</h4>
                                </div>
                            </div>
                        </a>
                    </div>

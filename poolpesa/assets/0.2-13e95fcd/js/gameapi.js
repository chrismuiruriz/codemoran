...
fg_api.prototype.socketModule = function () {
  ...
  module.prototype.connect = function (pUrl, pSessionId, pPlayer) {
    ...
    M.socket.on("connect", () => {
      console.log("... connection established!", pUrl, pSessionId, pPlayer);
...
fg_api.prototype.navigationModule = function () {
  ...
  module.prototype.init = function () {
    ...
    self.fgNavigation.style.opacity = "0";
  ...
  module.prototype.initializeFirebase = function () {
    ...
    M.promise = new Promise(function (resolve, reject) {
      ...
      faZepto.getScript(
        ...
        function () {
          faZepto.getScript(
            "https://www.gstatic.com/firebasejs/5.9.2/firebase-firestore.js",
            function () {
              faZepto.getScript(
